...
function ManageBookings() {
    ...
    useEffect(() => {
        const fetchBookings = async () => {
            try {
                const pendingResponse = await fetch('http://localhost:3000/pendingBookings');
                const confirmedResponse = await fetch('http://localhost:3000/bookings');
    ...
    const handleApprove = async (bookingId) => {
        try {
            ...
            await fetch(`http://localhost:3000/pendingBookings/${bookingId}`, {
                method: 'DELETE'
            });
    ...
    const handleSaveEdit = async (updatedBooking) => {
        try {
            const response = await fetch(`http://localhost:3000/bookings/${updatedBooking.id}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
